...
const Toast = () => {
    ...
    return (
        <div id="toast" className={`${store.toast.isToast ? 'translate-x-0' : 'translate-x-96'} z-50 transition relative flex items-center w-full max-w-xs p-4 mb-4 text-gray-700 bg-white rounded-lg shadow-md dark:text-gray-400 dark:bg-gray-800" role="alert`}>
